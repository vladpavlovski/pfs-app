...
export const PermissionRequestToast = props => {
  const { setPersistentValue, intl, closeToast, initializeMessaging } = props
          ...
          <ListItem>
            ...
            <ListItemText
              primary={intl.formatMessage({
                id: 'enable_notifications_message',
              })}
            />
          </ListItem>
...
PermissionRequestToast.propTypes = {
  closeToast: PropTypes.func,
  initializeMessaging: PropTypes.func,
