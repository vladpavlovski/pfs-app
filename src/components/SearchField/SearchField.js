...
SearchField.propTypes = {
  alwaysOpen: PropTypes.any,
  classes: PropTypes.shape({
    input: PropTypes.any,
    inputOpen: PropTypes.any,
    root: PropTypes.any,
    rootOpen: PropTypes.any,
...
const mapStateToProps = (state, ownProps) => {
  ...
  const searchValue = filters[filterName]
    ? filters[filterName].search
      ? filters[filterName].search.value
      : ''
    : ''
...
export default connect(mapStateToProps, { ...filterActions })(
  injectIntl(
    withTheme(withStyles(styles, { withTheme: true }, withWidth())(SearchField))
  )
)
