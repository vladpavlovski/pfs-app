...
const getCreateValues = (values, props) => {
  ...
  if (
    handleCreateValues !== undefined &&
    handleCreateValues instanceof Function
  ) {
...
const getUpdateValues = (values, props) => {
  ...
  if (
    handleUpdateValues !== undefined &&
    handleUpdateValues instanceof Function
  ) {
...
export default connect(null, { initialize })(FireForm)
