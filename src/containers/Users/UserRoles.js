...
UserRoles.propTypes = {
  ...
  userRolesPath: PropTypes.any,
  user_roles: PropTypes.shape({
    map: PropTypes.func,
  }),
...
const mapStateToProps = (state, ownProps) => {
  ...
  const userRolesPath = rootPath
    ? `/${rootPath}_user_roles/${uid}/${rootUid}`
    : `/user_roles/${uid}`
...
export default connect(mapStateToProps, { setSimpleValue })(
